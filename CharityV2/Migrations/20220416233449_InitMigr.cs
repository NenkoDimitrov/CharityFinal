    ...
    public partial class InitMigr : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Activitiys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Activitiys_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Activitiys_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Activitiys_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivitiesImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActivitiesImages_Activitiys_ActivitiyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivitiesImages_ActivitiyId",
                table: "ActivitiesImages",
                column: "ActivitiyId");

            migrationBuilder.CreateIndex(
                name: "IX_Activitiys_CategoryId",
                table: "Activitiys",
                column: "CategoryId");
